...
class breast_cancer():
    ...
    def __init__(self, root):
        ...
        self.label = Label(root, text='Detection of Cancer Type', font=('calibri', 30, 'bold'), bg='lightblue',fg='black')
        self.label.pack()

        self.label_1 = Label(root, text='Clump Thickness :',bg="pink", font=('arial', 10, 'bold'), fg='black')
        self.label_1.place(x=30, y=90)

        self.T1 = Entry(root, textvariable='t1', bd=2)
        self.T1.place(x=180, y=90)

        self.label_1 = Label(root, text='Uniform Cell Size :',bg="pink", font=('arial', 10, 'bold'), fg='black')
        self.label_1.place(x=30, y=140)

        self.T2 = Entry(root, textvariable='t2', bd=2)
        self.T2.place(x=180, y=140)

        self.label_1 = Label(root, text='Uniform Cell Shape :',bg="pink", font=('arial', 10, 'bold'), fg='black')
        self.label_1.place(x=30, y=190)

        self.T3 = Entry(root, textvariable='t3', bd=2)
        self.T3.place(x=180, y=190)

        self.label_1 = Label(root, text='Marginal Adhesion :',bg="pink", font=('arial', 10, 'bold'), fg='black')
        self.label_1.place(x=30, y=240)

        self.T4 = Entry(root, textvariable='t4', bd=2)
        self.T4.place(x=180, y=240)

        self.label_1 = Label(root, text='Single Epi Cell Size :',bg="pink", font=('arial', 10, 'bold'), fg='black')
        self.label_1.place(x=30, y=290)

        self.T5 = Entry(root, textvariable='t5', bd=2)
        self.T5.place(x=180, y=290)

        self.label_1 = Label(root, text='Bare Nuclei :',bg="pink", font=('arial', 10, 'bold'), fg='black')
        self.label_1.place(x=30, y=340)

        self.T6 = Entry(root, textvariable='t6', bd=2)
        self.T6.place(x=180, y=340)

        self.label_1 = Label(root, text='Bland Chromation :',bg="pink", font=('arial', 10, 'bold'), fg='black')
        self.label_1.place(x=30, y=390)

        self.T7 = Entry(root, textvariable='t7', bd=2)
        self.T7.place(x=180, y=390)

        self.label_1 = Label(root, text='Normal Nucleoli :',bg="pink", font=('arial', 10, 'bold'), fg='black')
        self.label_1.place(x=30, y=440)

        self.T8 = Entry(root, textvariable='t8', bd=2)
        self.T8.place(x=180, y=440)

        self.label_1 = Label(root, text='Mitosis :',bg="pink", font=('arial', 10, 'bold'), fg='black')
        ...
        acc_button = Button(root, text="RULES", bg="AZURE", font=('arial', 12), command=self.rules,bd=3)
        acc_button.place(x=450, y=100)
